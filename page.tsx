  ...
  return (
    <main className="min-h-screen bg-[#0a0e14] text-white selection:bg-[#C9A84C] selection:text-black">
      ...
      <section className="px-6 py-20 text-center relative overflow-hidden">
        ...
        <h1 className="text-6xl md:text-8xl font-black italic mb-6 leading-tight">FABULOUS <br /> <span className="text-[#C9A84C]">Logistics</span></h1>
      ...
      <section className="bg-black py-24 px-6 text-center rounded-t-[3rem] border-t border-gray-900">
        ...
        <div className="flex flex-col gap-4 max-w-md mx-auto">
          <a href="https://wa.me/2348036414646" className="bg-[#25D366] py-4 rounded-xl font-bold flex items-center justify-center gap-2">WhatsApp Support 1</a>
          <a href="https://wa.me/2348107215325" className="bg-[#25D366] py-4 rounded-xl font-bold flex items-center justify-center gap-2">WhatsApp Support 2</a>
        </div>
